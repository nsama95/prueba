...
@Component({
  selector: 'app-admin-reposicion',
  templateUrl: './admin-reposicion.component.html',
  styleUrls: ['./admin-reposicion.component.css']
})
export class AdminReposicionComponent implements OnInit {
  products: Product[];
