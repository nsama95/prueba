...
@Component({
  selector: 'app-mercaderia-form-employee',
  templateUrl: './mercaderia-form-employee.component.html',
  styleUrls: ['./mercaderia-form-employee.component.css']
})
export class MercaderiaFormEmployeeComponent implements OnInit {
  product: Product = {
    title: '',
    price: null,
    category: '',
  ...
  save() {
    ...
    this.router.navigate(['/employee/mercaderia']);
  }
