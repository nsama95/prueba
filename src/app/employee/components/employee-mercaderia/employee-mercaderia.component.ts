...
@Component({
  selector: 'app-employee-mercaderia',
  templateUrl: './employee-mercaderia.component.html',
  styleUrls: ['./employee-mercaderia.component.css']
})
export class EmployeeMercaderiaComponent implements OnInit {
