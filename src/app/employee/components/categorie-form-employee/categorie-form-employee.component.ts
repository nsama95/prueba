...
@Component({
  selector: 'app-categorie-form-employee',
  templateUrl: './categorie-form-employee.component.html',
  styleUrls: ['./categorie-form-employee.component.css']
})
export class CategorieFormEmployeeComponent implements OnInit {
