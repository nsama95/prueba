...
@Component({
  selector: 'app-product-form-employee',
  templateUrl: './product-form-employee.component.html',
  styleUrls: ['./product-form-employee.component.css'],
})
export class ProductFormEmployeeComponent implements OnInit {
  categories$;
